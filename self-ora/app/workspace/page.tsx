          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-card rounded-2xl p-4 sm:p-6 shadow-sm border border-border">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                  <div className="flex items-center gap-2">
                    <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Your Schedule</h2>
                      ...
                      return (
                        <div
                          ...
                          className={`flex-shrink-0 w-14 sm:w-16 flex flex-col items-center gap-2 py-3 rounded-xl transition-all cursor-pointer ${
                            isToday ? "bg-primary/10 border-2 border-primary" : "hover:bg-muted"
                          }`}
                        >
                          ...
                          {hasActivity && <div className="w-2 h-2 bg-green-500 rounded-full" />}
                        </div>
                      )
                    })}
                  </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4 mb-6">
                  <p className="text-sm text-foreground">
                    ...
                    <Link href="#" className="text-blue-600 dark:text-blue-400 underline hover:text-blue-700">
                      assignments
                    </Link>{" "}
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-6 shadow-sm border border-border">
                ...
                <p className="text-sm text-muted-foreground">4th October 2025</p>
              </div>
              ...
              <div className="bg-card rounded-2xl p-6 shadow-sm border border-border">
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  ...
                  <div className="bg-orange-50 dark:bg-orange-950/30 rounded-xl p-3 sm:p-4 text-center">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-foreground mb-1">91</p>
                  ...
                  <div className="bg-purple-50 dark:bg-purple-950/30 rounded-xl p-3 sm:p-4 text-center">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-foreground mb-1">63,802</p>
                  ...
                  <div className="bg-amber-50 dark:bg-amber-950/30 rounded-xl p-3 sm:p-4 text-center">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-foreground mb-1">17,610</p>
                ...
                <div className="flex justify-center mb-6">
                  <div className="relative w-40 h-40">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      ...
                      <span className="text-2xl font-bold text-foreground">0/100</span>
                    </div>
                  </div>
                </div>

                <div className="flex items-center justify-center gap-2 text-sm">
                  <span className="text-muted-foreground">Daily Goal Reward</span>
              ...
              <div className="bg-card rounded-2xl p-6 shadow-sm border border-border">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-2xl font-bold text-foreground">3/5 Days</span>
                ...
                <div className="space-y-3 pt-4 border-t border-border">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">Weekly Goal Reward</span>
                    <div className="flex items-center gap-1 text-orange-600 font-semibold">
                      <Coins className="w-4 h-4" />
                      <span>300</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">No. of Weekly Goals Achieved</span>
                    <span className="text-blue-600 font-semibold">22 Weeks</span>
                  </div>
                </div>
              </div>
            </div>
