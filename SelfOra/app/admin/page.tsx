...
export default function AdminDashboard() {
  ...
  const initializeTemplates = async () => {
    try {
      ...
      if (data.success) {
        setError("");
        setSuccess(`Successfully initialized ${data.data.length} templates`);
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      if (activeTab === "videos") {
        endpoint = "http://localhost:8000/admin/videos/";
      } else if (activeTab === "quotes") {
        endpoint = "http://localhost:8000/admin/quotes/";
      }
      ...
      if (data.success) {
        ...
        setError(data.message || `Failed to add ${activeTab.slice(0, -1)}`);
      }
    } catch (err) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (activeTab === "videos") {
        endpoint = `http://localhost:8000/admin/videos/${editingItem.id}/`;
      } else if (activeTab === "quotes") {
        endpoint = `http://localhost:8000/admin/quotes/${editingItem.id}/`;
      }
      ...
      if (data.success) {
        ...
        setError(data.message || `Failed to update ${activeTab.slice(0, -1)}`);
      }
    } catch (err) {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      if (activeTab === "videos") {
        endpoint = `http://localhost:8000/admin/videos/${id}/`;
      } else if (activeTab === "quotes") {
        endpoint = `http://localhost:8000/admin/quotes/${id}/`;
      }
      ...
      if (data.success) {
        ...
        setError(data.message || `Failed to delete ${activeTab.slice(0, -1)}`);
      }
    } catch (err) {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {(activeTab === "videos" || activeTab === "quotes") && (
                  <Button
                    onClick={openAddModal}
                    className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl font-medium"
                  >
                    <Plus size={20} />
                    Add New
                  </Button>
...
function VideosTable({
  ...
  onEdit: (video: LearningVideo) => void;
...
function QuotesTable({
  ...
  onEdit: (quote: MotivationalQuote) => void;
  onDelete: (id: number) => void;
}) {
  return (
    <div className="overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    min="0"
                    aria-label="Display order for videos"
                  />
                </div>
                ...
                <div className="flex items-center pt-8">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      aria-label="Active status for videos"
                    />
            ...
            <>
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("quote_text", e.target.value)
                  }
                  className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[100px]"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    min="0"
                    aria-label="Display order for quotes"
                  />
                </div>
                ...
                <div className="flex items-center pt-8">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 text-blue-600 rounded focus:ring-2 focus:ring-blue-500"
                      aria-label="Active status for quotes"
                    />
                    <span className="text-sm font-medium text-slate-700">
                      Active
                    </span>
